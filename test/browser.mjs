...
test('readDoubleLE', (t) => {
  ...
  t.test('other offset', (t) => {
    const buffer = new Uint8Array([...new Array(8).fill(0), ...[1, 2, 3, 4, 5, 6, 7, 8]])
  ...
  t.test('sub-buffer', (t) => {
    const buffer = new Uint8Array([...new Array(4).fill(0), ...[1, 2, 3, 4, 5, 6, 7, 8]])
    const sub = buffer.subarray(4)
...
test('readDoubleBE', (t) => {
  ...
  t.test('other offset', (t) => {
    const buffer = new Uint8Array([...new Array(8).fill(0), ...[8, 7, 6, 5, 4, 3, 2, 1]])
  ...
  t.test('sub-buffer', (t) => {
    const buffer = new Uint8Array([...new Array(4).fill(0), ...[8, 7, 6, 5, 4, 3, 2, 1]])
    const sub = buffer.subarray(4)
